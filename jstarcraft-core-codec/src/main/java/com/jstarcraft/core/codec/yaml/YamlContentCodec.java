 ...
 * @author Birdy
 */
public class YamlContentCodec implements ContentCodec {

    private static final Logger LOGGER = LoggerFactory.getLogger(YamlContentCodec.class);

    private final CodecDefinition codecDefinition;
    /** 类型转换器(基于Jackson) */
    private final YAMLMapper typeConverter = new YAMLMapper();

    public YamlContentCodec(CodecDefinition definition) {
