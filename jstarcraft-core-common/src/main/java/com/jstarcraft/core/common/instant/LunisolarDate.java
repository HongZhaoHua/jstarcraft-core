 ...
 *
 */
public class LunisolarDate implements CalendarDate {
     ...
     * @param date
     */
    public LunisolarDate(LocalDate date) {
     ...
     * @param day
     */
    public LunisolarDate(int year, int index, int day) {
        this.year = year;
     ...
     * @param day
     */
    public LunisolarDate(int year, boolean leap, int month, int day) {
        this.year = year;
        this.leap = leap;
        this.month = month;
        // 检查是否存在指定的天数
    ...
    public boolean equals(Object object) {
        ...
        if (getClass() != object.getClass())
            return false;
        LunisolarDate that = (LunisolarDate) object;
