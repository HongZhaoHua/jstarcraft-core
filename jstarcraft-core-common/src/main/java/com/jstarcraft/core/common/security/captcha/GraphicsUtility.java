...
public class GraphicsUtility {
    ...
    public static Color randomColor() {
        return new Color(RandomUtility.randomInteger(256), RandomUtility.randomInteger(256), RandomUtility.randomInteger(256));
    }
    ...
    public static Graphics drawString(Graphics g, String str, Font font, Color color, Rectangle rectangle) {
        ...
        Dimension dimension;
        try {
            dimension = getDimension(g.getFontMetrics(font), str);
        } catch (Exception e) {
            // 此处报告bug某些情况下会抛出IndexOutOfBoundsException，在此做容错处理
