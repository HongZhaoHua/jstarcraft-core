...
public class AtomicDoubleArray implements java.io.Serializable {
    ...
    private transient AtomicLongArray values;
    ...
    public AtomicDoubleArray(int length) {
        this.values = new AtomicLongArray(length);
    }
    ...
    public AtomicDoubleArray(double[] array) {
        ...
        this.values = new AtomicLongArray(longArray);
    }
    ...
    public final double get(int i) {
        return longBitsToDouble(values.get(i));
    }
    ...
    public final double getAndSet(int i, double newValue) {
        long next = doubleToRawLongBits(newValue);
        return longBitsToDouble(values.getAndSet(i, next));
    }
    ...
    public final boolean compareAndSet(int i, double expect, double update) {
        return values.compareAndSet(i, doubleToRawLongBits(expect), doubleToRawLongBits(update));
    }
    ...
    public final boolean weakCompareAndSet(int i, double expect, double update) {
        return values.weakCompareAndSet(i, doubleToRawLongBits(expect), doubleToRawLongBits(update));
    }
    ...
    public String toString() {
        ...
        b.append('[');
        for (int i = 0;; i++) {
            b.append(longBitsToDouble(values.get(i)));
            if (i == iMax) {
