 ...
 * @author Birdy
 */
public class DelayDouble implements Delayed {
    ...
    public DelayDouble(double content, Instant expire) {
        this(content, Date.from(expire));
    }

    public DelayDouble(double content, Date expire) {
    ...
    public int hashCode() {
        final int prime = 31;
        int hash = 1;
        hash = prime * hash + Double.hashCode(content);
    ...
    public boolean equals(Object object) {
        ...
        if (getClass() != object.getClass())
            return false;
        DelayDouble other = (DelayDouble) object;
