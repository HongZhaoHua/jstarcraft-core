 ...
 * @author Birdy
 */
public class DelayFloat implements Delayed {
    ...
    public DelayFloat(float content, Instant expire) {
        this(content, Date.from(expire));
    }

    public DelayFloat(float content, Date expire) {
    ...
    public int hashCode() {
        final int prime = 31;
        int hash = 1;
        hash = prime * hash + Float.hashCode(content);
    ...
    public boolean equals(Object object) {
        ...
        if (getClass() != object.getClass())
            return false;
        DelayFloat other = (DelayFloat) object;
