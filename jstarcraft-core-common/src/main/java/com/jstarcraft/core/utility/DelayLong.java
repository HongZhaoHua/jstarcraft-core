 ...
 * @author Birdy
 */
public class DelayLong implements Delayed {
    ...
    public DelayLong(long content, Instant expire) {
        this(content, Date.from(expire));
    }

    public DelayLong(long content, Date expire) {
    ...
    public int hashCode() {
        final int prime = 31;
        int hash = 1;
        hash = prime * hash + Long.hashCode(content);
    ...
    public boolean equals(Object object) {
        ...
        if (getClass() != object.getClass())
            return false;
        DelayLong other = (DelayLong) object;
