...
public class LunarExpressionTestCase {
    ...
    private List<LocalDateTime> dateTimes = new ArrayList<>();
    {
        ...
        dateTimes.add(LocalDateTime.of(2020, 2, 22, 0, 0, 0));
        ...
        dateTimes.add(LocalDateTime.of(2020, 6, 20, 0, 0, 0));
        ...
        dateTimes.add(LocalDateTime.of(2020, 8, 18, 0, 0, 0));
        dateTimes.add(LocalDateTime.of(2020, 8, 19, 0, 0, 0));
        dateTimes.add(LocalDateTime.of(2020, 9, 16, 0, 0, 0));
        ...
        dateTimes.add(LocalDateTime.of(2020, 11, 14, 0, 0, 0));
        ...
        dateTimes.add(LocalDateTime.of(2021, 1, 12, 0, 0, 0));
    ...
    public void testGetPreviousDateTime() {
        LunarExpression expression = new LunarExpression("0 0 0 1,-1 *");
    ...
    public void testYear() {
        LunarExpression expression = new LunarExpression("0 0 0 1,-1 * 2020");
        {
