...
import com.jstarcraft.core.event.memory.AsynchronousEventBus;
import com.jstarcraft.core.utility.NameThreadFactory;

public class AsynchronousEventBusTestCase extends EventBusTestCase {

    protected static final Logger logger = LoggerFactory.getLogger(AsynchronousEventBusTestCase.class);

    private ThreadPoolExecutor pool;

    @Override
    protected EventBus getEventBus(EventMode mode) {
        return new AsynchronousEventBus(mode, pool);
    }
