package com.jstarcraft.core.io.fastdfs;
...
public class FastdfsStreamManager implements StreamManager {
    ...
    public FastdfsStreamManager(FileSystem system, String directory) {
        this.system = system;
