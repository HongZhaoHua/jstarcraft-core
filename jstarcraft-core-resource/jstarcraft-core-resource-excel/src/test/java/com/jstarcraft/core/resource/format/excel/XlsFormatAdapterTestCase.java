...
public class XlsFormatAdapterTestCase {

    @ResourceAccessor
    private ResourceManager<Integer, XlsBiology> manager;

    @ResourceAccessor("1")
    private XlsBiology cat;
    @ResourceAccessor("2")
    private XlsBiology dog;
    @ResourceAccessor("3")
    private XlsBiology tree;
    @ResourceAccessor("4")
    private XlsBiology shrub;
