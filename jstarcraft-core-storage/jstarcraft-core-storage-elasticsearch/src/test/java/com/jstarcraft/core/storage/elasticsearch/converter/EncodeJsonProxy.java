...
public class EncodeJsonProxy {

    /** 类:代理后缀 */
    protected final static String CLASS_SUFFIX = "_ENCODE_CONVERTER";
    ...
    public <T> Converter<T, String> getToConverter(Class<T> clazz) {
        try {
            Constructor constructor = getConverterConstructor(clazz);
            Converter<T, String> converter = (Converter<T, String>) constructor.newInstance(clazz);
            return converter;
     ...
     * 
     * <pre>
     * public class {clazz.name}_DECODE_CONVERTER extends AbstractConverter<clazz.name, String> implements Converter<clazz.name, String> {
     * }
     * </pre>
     * 
     * @param clazz
    ...
    private void proxyMethods(Class<?> clazz, CtClass proxyClass) throws Exception {
        ...
        StringBuilder methodBuilder = new StringBuilder("{");
        methodBuilder.append(StringUtility.format("return com.jstarcraft.core.common.conversion.json.JsonUtility.object2String($1);"));
        methodBuilder.append("}");
    ...
    public static void main(String[] arguments) throws Exception {
        EncodeJsonProxy proxy = new EncodeJsonProxy();
        Converter<Boolean, String> converter = proxy.getToConverter(Boolean.class);
