 ...
 *
 */
public class MongoXmlParser extends AbstractBeanDefinitionParser {

    private static final Logger LOGGER = LoggerFactory.getLogger(MongoXmlParser.class);
    ...
    protected AbstractBeanDefinition parseInternal(Element element, ParserContext parserContext) {
        ...
        factory.addPropertyValue(MongoAccessorFactory.CLASSES, classes);
